...
def getSentenceFeatures(tokens, wordVectors, sentence):
    ...
    # YOUR CODE HERE
    word_idxs = [tokens[word] for word in sentence]
    sent_vectors = wordVectors[word_idxs]
    sentVector += np.sum(sent_vectors, axis=0)
...
def getRegularizationValues():
    ...
    # YOUR CODE HERE
    values = np.logspace(-5, 3, num=100, base=10)
    # END YOUR CODE
...
def chooseBestModel(results):
    ...
    # YOUR CODE HERE
    bestResult = max(results, lambda model: model['dev'])
    # END YOUR CODE
